    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="images/photo_2019-03-29_23-09-14.jpg" height="50" width="50" alt="User Image">
        <div>
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Fontend</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          ...
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="add_menu.php"><i class="icon fa fa-circle-o"></i>Add Menu</a></li>
            <li><a class="treeview-item" href="manage_menu.php"><i class="icon fa fa-circle-o"></i>Manage Menu</a></li>
          </ul>
        </li>
