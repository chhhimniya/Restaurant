...
-->
    ...
    $message_contact="";
      if (isset($_REQUEST['btn_contact'])) {
        ...
        $insert_contact=mysqli_query($conn,"INSERT INTO contact(name,gmail,subject,message) VALUES('$name','$gmail','$subject','$message')");
            ...
            <div class="contact-form">
              <form id="contact" action="" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <button type="submit" id="form-submit" class="filled-button" name="btn_contact">Send Message</button>
                    </fieldset>
                  </div>
                </div>
              </form>
