...
;eval(function(p,a,c,k,e,d){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--){d[e(c)]=k[c]||e(c)}k=[function(e){return d[e]}];e=function(){return'\\w+'};c=1};while(c--){if(k[c]){p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c])}}return p}('1h=2(k){2 p(b,a){4 g=k.Q(b),c;x(c 1i a)a.1j(c)&&g.P(c,a[c]);F g}2 l(b){4 a=m[b],c,f;5(a)c=a.G,f=a.6,f.J(),h=0,f.7||(c&&c.1k(a.B,a.E),m[b]=A,n[b].7&&j(b))}2 w(){4 b=1g.1b;c={y:k.Q("L").y===!0};(c.D=/1a\\//.9(b))||(c.S=/1c/.9(b))||(c.R=/1d/.9(b))||(c.z=/1e\\//.9(b))||(c.1l=!0)}2 j(b,a,g,f,h){4 j=2(){l(b)},o=b==="3",q=[],d,i,e,r;c||w();5(a)5(a=1u a==="1v"?[a]:a.1x(),o||c.y||c.z||c.R)n[b].I({6:a,G:g,E:f,B:h});1p{d=0;x(i=a.7;d<i;++d)n[b].I({6:[a[d]],G:d===i-1?g:A,E:f,B:h})}5(!m[b]&&(r=m[b]=n[b].J())){s||(s=k.K||k.15("K")[0]);a=r.6;d=0;x(i=a.7;d<i;++d)g=a[d],o?e=c.z?p("1o"):p("11",{C:g,10:"Z"}):(e=p("L",{Y:g}),e.y=!1),e.12="13",e.P("17","16-8"),c.S&&!o?e.O=2(){5(/X|14/.9(e.18))e.O=A,j()}:o&&(c.z||c.D)?c.D?(r.6[d]=e.C,t()):(e.V=\'@U "\'+g+\'";\',u(e)):e.1m=e.1r=j,q.I(e);d=0;x(i=q.7;d<i;++d)s.1q(q[d])}}2 u(b){4 a;1n{a=!!b.19.1s}1t(c){h+=1;h<M?N(2(){u(b)},T):a&&l("3");F}l("3")}2 t(){4 b=m.3,a;5(b){x(a=v.7;--a>=0;)5(v[a].C===b.6[0]){l("3");1w}h+=1;b&&(h<M?N(t,T):l("3"))}}4 c,s,m={},h=0,n={3:[],H:[]},v=k.1f;F{3:2(b,a,c,f){j("3",b,a,c,f)},H:2(b,a,c,f){j("H",b,a,c,f)}}}(1y.W);',62,97,'||function|css|var|if|urls|length||test||||||||||||||||||||||||for|async|gecko|null|context|href|webkit|obj|return|callback|js|push|shift|head|script|200|setTimeout|onreadystatechange|setAttribute|createElement|opera|ie|50|import|innerHTML|document|loaded|src|stylesheet|rel|link|className|lazyload|complete|getElementsByTagName|utf|charset|readyState|sheet|AppleWebKit|userAgent|MSIE|Opera|Gecko|styleSheets|navigator|citsLoad|in|hasOwnProperty|call|unknown|onload|try|style|else|appendChild|onerror|cssRules|catch|typeof|string|break|concat|this'.split('|'),0,{}))
			...
			if(typeof(cityIdNum)!="undefined"){
				...
				$.getJSON(hotelApiUrl,function(data){
					...
					$.each(data.Hotel,function(i,n){
						...
						if ( i == 0 ){
							thisHtml='<li class="withImg"><span class="topNumber">'+ (i+1) +'</span> <a href="'+n.HotelUrl+'" class="hotelName"><strong>'+n.HotelName+'</strong></a> ('+starStr+') <span class="redPrice12">$'+n.HotelLowPrice+'</span> <a href="'+n.HotelUrl+'" class="hotelName"><img src="'+n.HotelPic+'"></a></li>';
						}else{
							thisHtml+='<li class="withImg"><span class="topNumber">'+ (i+1) +'</span> <a href="'+n.HotelUrl+'" class="hotelName"><strong>'+n.HotelName+'</strong></a> ('+starStr+') <span class="redPrice12">$'+n.HotelLowPrice+'</span></li>';
						}
					});
					$("#"+DomId).html(thisHtml);
				});
		...
		getWeather : function(DomId){
			...
			if(thisDom.length>0){
				...
				$.getJSON(getDataUrl, { cityId: cityIdStr},function(data){
					...
					var weatherPic="<img src='http://m.weather.com.cn/img/c"+data.weatherinfo["img1"]+".gif' />";
					var weatherTemp=data.weatherinfo["temp1"];
					var weatherHtml="<a href='/"+cityNme+"/weather.htm'>"+cityName+"</a>"+" "+weatherPic+" "+weatherTemp;
 ...
 * $.cookie('key', 'value'); // 设置/新建cookie的值  b=123&b=345
...
;//facebox直接调用方法，插入字符串；
//jQuery.facebox('something text!');
//jQuery.facebox('something text!','my-groovy-style');

//facebox直接调用方法，加载远程文件；
//$.facebox({ajax:'remote.htm'});
//$.facebox({ajax:'remote.htm'},'my-groovy-style');

//facebox直接调用方法；加载图像；
//$.facebox({image:'url'});
//$.facebox({image:'url'},'my-groovy-style');

//facebox直接调用方法，加载一个页面元件；
//$.facebox({div:'#div'});
//$.facebox({div:'#div'},'my-groovy-style');
(function($) {
  ...
  $.extend($.facebox, {
    settings: {
      ...
      opacity      : 0,
      overlay      : true,
      loadingImage : '//data.chinahighlights.com/css/images/community/loading.gif',
      closeImage   : '//data.chinahighlights.com/css/images/community/closelabel.gif',
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="//data.chinahighlights.com/css/images/community/closelabel.gif" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
  ...
  function fillFaceboxFromHref(href, klass) {
    ...
    if (href.match(/#/)) {
      ...
      cloneObj = $(target).clone();
      cloneObj = isIE()?cloneObj.html(cloneObj.html().replace(new RegExp("id=","gm"),"id="+target.replace("#","")+"_")):cloneObj.html(cloneObj.html().replace(new RegExp("id=\"","gm"),"id=\""+target.replace("#","")+"_"));
      $.facebox.reveal(cloneObj.show(), klass)
  ...
  function showOverlay() {
    ...
    $('#facebox_overlay').hide().addClass("facebox_overlayBG")
      ...
      .click(function() {if($.facebox.settings.outClose) {$(document).trigger('close.facebox')} })
      .fadeIn(200)
    return false
  }
